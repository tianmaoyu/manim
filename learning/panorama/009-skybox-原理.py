...
class DemoSkybox008(ThreeDScene):
    def construct(self):
        ...
        self.move_camera(phi=180 * DEGREES, theta=0 * DEGREES,run_time=2)
        ...
        obj2.points = np.array(new_cube_points)*2
        self.move_camera(phi=145 * DEGREES, theta=15 * DEGREES,run_time=2)
        self.wait(7)
